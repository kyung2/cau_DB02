...
public class ElmSchoolListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ListByGPSTask(this,"/elemSchool/gps/","elemschool"){
            @Override
...
/// values('id', 'name', 'si_do', 'si_gun_gu', 'tel', 'latitude', 'longitude')[:20]
                        arrayList.add(new IdAndString(row.getInt("id"),
                                ...
                                row.getString("name")
                                        ...
                                        + "" + row.getDouble("longitude"), IdAndString.ElmSchoolListActivity)
                        );
                    } catch (Exception e) {
