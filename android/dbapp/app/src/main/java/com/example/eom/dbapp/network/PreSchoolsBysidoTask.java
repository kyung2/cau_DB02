...
public abstract class PreSchoolsBysidoTask extends AsyncTask<String, Void, ArrayList<PreSchoolData>> {
    //data={"user_id":19,"longitude":126.95,"latitude":37.50,"range":1}37.50,126.95
    private String si_do;

    protected PreSchoolsBysidoTask(String si_do) {
        this.si_do = si_do;
    }
    ...
    protected ArrayList<PreSchoolData> doInBackground(String... params) {
        ...
        try {
            ...
            Log.d("PreSchoolsBysidoTask", strResult);
